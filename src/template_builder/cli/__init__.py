...
from src.template_builder import _make_stencil_app_config
from src.template_builder import _make_cache_config
from src.template_builder import write_new_conf_file
...
if app_conf.doc_version != __app_doc_version__:
    correct_version: int = resolve_version_dif(__app_doc_version__, app_conf.doc_version)
    if correct_version == -1:
